...
Visualizing erasmus plus students data with `ggplot2`:

```{r erasmus_plus_bar,ggplot2, fig.width=6, fig.height=3}
library(ggplot2)
p <- ggplot(erasmus_plus, aes(x = `Årstall`, y = `Antall totalt`)) 
p <- p + geom_col()
print(p)
```
