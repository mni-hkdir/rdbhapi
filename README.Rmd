...
[![Codecov test coverage](https://codecov.io/gh/mni-hkdir/rdbhapi/branch/main/graph/badge.svg)](https://codecov.io/gh/mni-hkdir/rdbhapi)
...
**rdbhapi** provides an R interface for accessing the open data available through [DBH-API](https://dbh.hkdir.no/dbhapiklient/).
It allows users to query, filter, and retrieve data directly into R for further analysis.
