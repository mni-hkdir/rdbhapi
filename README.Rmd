...
![Favicon](man/figures/pkgdown/favicon.ico)
...
```{r example}
library(knitr)
library(rdbhapi, warning=FALSE, message=FALSE, results='asis',echo=TRUE, eval=TRUE)
...
```{r rdbhapi, warning=FALSE, message=FALSE, results='asis',echo=TRUE, eval=TRUE}
library(knitr)
